...
export class Apps {
  constructor(api) {
    ...
    this.ap2deg = 0;
    this.ap1src = '';
    this.ap1style = 'position: fixed; left: 5%; top: 50%; width: 25%; height: 45%; background-color: rgba(250, 250, 250, 0.9);';

    this.ap2src = '';
    this.ap2style = 'position: fixed; left: 37%; top: 50%; width: 25%; height: 45%; background-color: rgba(250, 250, 250, 0.9);';
    this.showap1 = false;
    this.showap2 = false;
  ...
  activate(params, routeConfig, navigationInstruction) {
    ...
    if (params.target) {
      ...
      for (let kvitem of kv) {
        ...
        if (keyvalue[0] === 'ap2') this.toggleapp(1, keyvalue[1]); else {this.toggleapp(0, keyvalue[1]);}
