...
<bdl-fb-set-state title="2.KOB biochemie" value="screen/k2vysetreni.md"></bdl-fb-set-state>
<bdl-fb-set-state title="3.Astrup ABR" value="screen/k3vysetreniastrup.md"></bdl-fb-set-state>
...
<bdl-fb-set-state title="2.CBC biochem." value="screen/k2exam-blood-en.md"></bdl-fb-set-state>
<bdl-fb-set-state title="3.Astrup ABB" value="screen/k3exam-astrup-en.md"></bdl-fb-set-state>
