...
<bdl-fb-set-state title="2.Vyš. krevního obrazu a biochemie" value="screen/k1vysetreni9q.md"></bdl-fb-set-state>

<bdl-fb-set-state title="3.Vyš. ASTRUP a ABR" value="screen/k1vysetreniastrup.md"></bdl-fb-set-state>
