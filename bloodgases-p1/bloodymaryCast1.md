...
<bdl-bind2a-text findex="656" aname="children.0.Cast1_CtvCO2_text" prefix="Ca CO2:" suffix=" ml CO2/l"></bdl-bind2a-text>
<bdl-bind2a-text findex="645" aname="children.0.Cast1_CtvO2_text" prefix="Ca O2: " suffix=" ml O2/l"></bdl-bind2a-text>
<bdl-bind2a-text findex="740" aname="children.0.Cast1_CtvCO2_text_1" prefix="CvCO2:" suffix=" ml O2/l"></bdl-bind2a-text>
<bdl-bind2a-text findex="739" aname="children.0.Cast1_CtvO2_text_1" prefix="CvO2: " suffix=" ml O2/l"></bdl-bind2a-text>
<bdl-bind2a-text findex="652" aname="children.0.Cast1_DCO2_text" convertor="60000,1" suffix="ml CO2/min"></bdl-bind2a-text>
<bdl-bind2a-text findex="650" aname="children.0.Cast1_DO2_text" convertor="60000,1" suffix="ml O2/min"></bdl-bind2a-text>
<bdl-bind2a-text findex="654" aname="children.0.Cast1_VDCO2_text" convertor="60000,1" suffix=" ml O2/min"></bdl-bind2a-text>
<bdl-bind2a-text findex="653" aname="children.0.Cast1_VDO2_text" convertor="60000,1" suffix="ml O2/min"></bdl-bind2a-text>
...
<bdl-bind2a-text findex="647" aname="children.0.Cast1_MO2_text" suffix="ml O2/min" fixed="0"></bdl-bind2a-text>
