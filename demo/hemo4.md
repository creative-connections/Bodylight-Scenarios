...
<bdl-value-boolean valuetrue=" aortic valve opened" valuefalse=" aortic valve closed" fromid="id4" refindex="7"></bdl-value-boolean>

<bdl-value-boolean valuetrue=" mitral valve opened" valuefalse=" mitral valve closed" fromid="id4" refindex="6"></bdl-value-boolean>

<bdl-value-boolean valuetrue=" tricuspid valve opened" valuefalse=" tricuspid valve closed" fromid="id4" refindex="14"></bdl-value-boolean>

<bdl-value-boolean valuetrue=" pulmonary valve opened" valuefalse=" pulmonary valve closed" fromid="id4" refindex="15"></bdl-value-boolean>

</div>
<div class="w3-col l4">
<bdl-chartjs-time id="id11" width="350" height="200" fromid="id4" maxdata="512" labels="Left Ventricle Pressure, Aorta Pressure, Pressure in Left Atria" refindex="1" refvalues="3" ylabel="pressure (mmHg)" xlabel="time (s)" convertors="0.00750062,1;0.00750062,1;0.00750062,1" throttle="500"></bdl-chartjs-time>
