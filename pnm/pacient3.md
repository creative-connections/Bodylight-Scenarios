...
<!-- not optimalized -O0 --><bdl-fmi id="idfmi" mode="continuous" showcontrols="false" controlid="controlbuttons2" src="modelECMORespiratoryVR_BloodGasesTransport_BloodyMaryPPG2.js" fminame="modelECMORespiratoryVR_BloodGasesTransport_BloodyMaryPPG2" tolerance="0.00001" starttime="0" fstepsize="0.4" fpslimit="0.5" guid="{83d444de-f6b1-4a60-a953-199d3e7b2d57}" valuereferences="905975257,369103464,905975068,905975254,905974373,905975067,905975342,905972510,16777311,16777312,905975256,335544320,637537073,637538918,637538919,16777379" valuelabels="venous.sO2,arterial.sO2,tissueUnit[1].sO2,venous.pH,arterial.pH,tissueUnit[1].pH,AirO2.y,AirN2,AirCO2,AirH2O,venous.pCO2,plethy,respiratoryCenter.VentilationSwitch.y,arterial.pO2,arterial.pCO2,respiratoryUnit[1].Diffusion" inputs="idrate,16777223,1,60,t;idco2,16777311,1,100,t;idh2o,16777312,1,100,t;idshunts,16777227,1,100,t;iddeadspace,16777225,1,1000000,t;ido2,16777547,1,100,t;idventilation,16777511,1,1,t;iddif,16777379,1e-5,1,t" inputlabels="RR,AirCO2,AirH2O,cShuntFrac,DV,AirO2Fraction.k,respiratoryCenter.ArtificialVentilation.k,respiratoryUnit[1].Diffusion"></bdl-fmi>
...
3. Pacient 55 let, muž, s dýchacími obtížemi. Oxygenoterapie na 80% O<sub>2</sub> nedostatečná. Zaintubován na umělou plicní ventilaci.
<bdl-quizx id="q2.0" type="match" 
          question="3.1 Při oxygenoterapii hrozí otrava kyslíkem. Přiřaďte ke stavům tkání jejich popis."
          terms="hyperoxie|hypoxie"
          answers="zvýšená koncentrace (parciální tlak) kyslíku může mít toxické účinky|snížeá koncentrace kyslíku, může mít vliv na změnu metabolismu na anaerobní" 
...
Ventilation: <!--bdl-buttonparams title="Normal" ids="ido2,idco2,idh2o" values="21,0.03,6"></bdl-buttonparams>
...
Diffusion: <bdl-value fromid="idfmi" refindex="15"></bdl-value> <bdl-range id="iddif" title="diffusion [mol2][s-1][J-1].1e-5" min="1" max="100" default="10" step="1"></bdl-range><br/>
