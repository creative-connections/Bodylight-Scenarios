...
&nbsp;<bdl-chartjs-time responsive="true" height="60" fromid="ventilator" labels="lungs pressure"  refindex="9" refvalues="1" minichart="true" colorindex=5 initialdata="0,0.01;1.014e+5,1.014e+5"></bdl-chartjs-time>
&nbsp;<bdl-chartjs-time responsive="true" height="60" fromid="hemodynamics" labels="ecg" refindex="3" refvalues="1" throttle="100" colorindex="2" minichart="true" initialdata="0,0.01;0,0"></bdl-chartjs-time>
&nbsp;<bdl-chartjs-time responsive="true" height="60" fromid="hemodynamics" labels="pulsatile sO2" refindex="0" refvalues="1" throttle="100" colorindex="11" minichart="true" initialdata="0,0.01;11370,11370"></bdl-chartjs-time>
</div>
...
<!-- debug controls -->
<bdl-buttonparams title="1.phase (normal)" ids="idshunts,iddeadspace,idrate,idcomp" values="2,150,17,60" fromid="vrapi" thresholdvalue="0" refindex="5" ></bdl-buttonparams> 
...
<bdl-buttonparams title="2.phase (ventilated)" ids="idshunts,iddeadspace,idrate,idcomp" values="58,850,33,10" fromid="vrapi" refindex="5" thresholdvalue="2"></bdl-buttonparams>
...
<button class="w3-button w3-blue" onclick="['idNIBP', 'idNIBP2', 'idP', 'idV','idetco2','idPO2'].forEach(id => document.getElementById(id).style.display = 'inline');">Show vent. values</button>
<button class="w3-button w3-blue" onclick="['idRR', 'idHR', 'idpH', 'idpHven','idpHmix','spo2value','idNIBP', 'idNIBP2', 'idP', 'idV','idetco2','idPO2'].forEach(id => document.getElementById(id).style.display = 'none');">Hide values</button>
...
compliance <bdl-value fromid="ventilator" refindex="12" convertor="1e+10,98.0665"></bdl-value> <bdl-range id="idcomp" title="total compliance (ml/cmH20)" min="10" max="200" default="60" step="1" initdefault="true"></bdl-range>
