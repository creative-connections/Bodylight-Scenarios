...
package FeMetabolism
  model FeMetabolismModel
    "Implementation of Enulescu et al. PLOS Comput. Biol. 2017 Fe metabolism model: final version"
    ...
    // Hepcidin expression
    //################################################
    Real hep(start=0.664938,unit="ug") "Hepcidin ammount (s16 )";
    Real Bmp6(start=15.8291,unit="ug") "Bmp6 ammount (s18)";
    Real LPS(start=0.000,fixed=true,unit="ug") "LPS (Lipopolysaccharide) ammount (s23)"; //1.00 hodnota z clanku
    ...
    Real Fpn_liv(start=1.00036,unit="ug") "Fpn ammount in liver (s12)";
    Real Fpn_spl(start=1.00049,unit="ug") "Fpn ammount in spleen (s14)";
    Real Fpn_duo(start=1.00017,unit="ug") "Fpn ammount in duodenum (s13)";
    Real Fpn_res(start=1.00020,unit="ug") "Fpn ammount in other organs (s15)";

    // Dynamics of the iron pools
    //################################################
    Real Fe_liv(start=76.9562,unit="ug") "Fe ammount in liver (s2)";
    Real Fe_spl(start=17.7295,unit="ug") "Fe ammount in spleen (s5)";
    Real Fe_bm(start=63.1596,unit="ug") "Fe ammount in bones (s3)";
    Real Fe_RBC(start=1016.720,unit="ug") "Fe ammount in red blood cells (s6)";
    Real Fe_duo(start=2.97118,unit="ug") "Fe ammount in duodenum (s4)";
    Real Fe_res(start=466.811,unit="ug") "Fe ammount in other organs (s10)";
    Real Fe_ser(start=1.51304,unit="ug") "Fe ammount in serum (s1)";
