...
<bdl-quiz id="q1" question="2.1 Spárujte související jevy - při pochybnosti spusťte simulaci a vzykoušejte." terms="snížení sklonu Starlingovy křivky pravého srdce|snížení sklonu Starlingovy křivky levého srdce|zvýšení systémové rezistence" answers="městnání krve ve velkých (systémových) žilách|městnání krve v plicních žilách|zvýšení objemu a tlaku krve v artériích" type="match"></bdl-quiz>

<bdl-quiz id="q2" question="2.2 Spusťte simulaci a přiřaďte normální (obvyklé) hodnoty k veličinám" terms="celkový objem krve|elastický objem (stressed volume)|neelastický objem (unstressed volume)" answers="přibližně 5 <i>l</i> | přibližně 1.5l| přibližně 3.5l" type="match"></bdl-quiz>

<bdl-quiz id="q3" question="2.3 V simulaci změňte váhu a výšku postavy. Sledujte BMI a přiřaďte co se děje" terms="zvýšená váha a výška - zachované BMI|snížená váha a snížená výška - zachováno BMI" answers="Zvýšený objem krve | snížený objem krve" type="match"></bdl-quiz>
